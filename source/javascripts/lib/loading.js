$(function(){
  ...
  bar.setAttribute('style', 'color:#f75228;font-weight:bold;float:right;background:#000;height:20px;margin-top:-20px;width:100%');
  cursor.setAttribute('style', 'z-index:9999999;color:#f75228;font-weight:bold;position:fixed;bottom:0;right:0');
